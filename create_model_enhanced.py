...
# Create the full pipeline without calibration
pipe = Pipeline(steps=[
    ('preprocessor', preprocessor),
    ('classifier', base_clf)  # Removed calibration to reduce complexity
])
...
print("\nSaving model...")
# Save the model using joblib instead of pickle
joblib.dump(pipe, 'ra_pipe.pkl', compress=3)

print("Done! Model saved as ra_pipe.pkl") 